...
- [`nvim`](https://github.com/MysticalDevil/nvim): A full Neovim setup mainly written in TypeScript and Rust.
- [`nvim-lite`](https://github.com/MysticalDevil/nvim-lite): A smaller and easier-to-understand version of my Neovim config.
- [`zite`](https://github.com/MysticalDevil/zite): A SQLite Data Mapper-style ORM built with Zig for learning and experimentation.
